...
export class CanvasViewComponent implements OnInit {
  ...
  public controllerform: FormArray;
  constructor(private _fb: FormBuilder) { }

  ngOnInit() {
    this.controllerform = this._fb.array([]);
    const control = <FormArray>this.controllerform;

    control.insert(0, this.initForm(this.formObj));
